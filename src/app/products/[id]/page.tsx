    ...
    return (
      <div className="bg-gray-50 py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">お客様の声</h2>
          <p className="mt-4 text-gray-600">この商品のレビューはまだありません。</p>
          <a href="/submit-review" className="mt-6 inline-block px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
            最初のレビューを投稿する
          </a>
        </div>
      </div>
